...
<<<<<<< HEAD:ign_ros2_control_demos/launch/cart_example_velocity.launch.py
    ignition_spawn_entity = Node(
=======
    gz_spawn_entity = Node(
>>>>>>> ab810e7 (Renamed ign to gz (#67)):gz_ros2_control_demos/launch/cart_example_velocity.launch.py
        package='ros_gz_sim',
        executable='create',
        output='screen',
